...
[![license](https://img.shields.io/github/license/Octonove/capturapro)](LICENSE)
[![release](https://img.shields.io/github/v/release/Octonove/capturapro)](https://github.com/Octonove/capturapro/releases/latest)
[![platform](https://img.shields.io/badge/platform-Windows%2010%2F11-1E3A5F)](https://github.com/Octonove/capturapro/releases/latest)

Screenshots, GIFs and screen recordings for Windows — annotated, watermark-free, 100% local.

**Free · Open source (MIT) · 100% local — nothing ever leaves your PC · No accounts, no limits, no watermarks**

<img src="docs/screenshot.png" width="720" alt="CapturaPro screenshot">
...
- GIFs and short recordings with **no watermark and no time limits**
- System audio + microphone, native-quality encoding (FFmpeg bundled)
- Everything runs and stays on your PC — no accounts, no uploads

## Download (Windows 10/11)

### ➡️ [**Download CapturaPro (installer .exe)**](https://github.com/Octonove/capturapro/releases/latest/download/CapturaPro-Setup.exe)
...
> ⭐ **If CapturaPro is useful to you, a star on GitHub is the best way to support it — it costs nothing and helps a lot.**
